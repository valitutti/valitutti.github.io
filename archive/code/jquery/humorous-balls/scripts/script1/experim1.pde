  ...
  if (step == 2){
    if (time < 8) {
      ...
      ball2.display();
        ...
        s1.content = "What do I see? A fat and big purple ball";
        s1.location.x = 10;
        s1.location.y = 430;
        s1.display();
    
        s2.content = "that's haunting a small red ball!";
        s2.location.x = 10;
        s2.location.y = 470;
        s2.fontSize = 25;
        s2.display();
  ...
  if (step == 3){
    if (time < 12) {
      ...
      ball2.display();
        ...
        s1.content = "The little ball tries to escape";
        s1.location.x = 10;
        s1.location.y = 430;
        s1.display();
    
        s2.content = "but is hit again and again.";
        s2.location.x = 10;
        s2.location.y = 470;
        s2.fontSize = 25;
        s2.display();
...
void step4(){
  if (step == 4){
    if (time < 16) {
      ...
      s1.content = "We have to help the little red ball!";
      s1.location.x = 10;
      s1.location.y = 430;
      s1.display();
...
void step5(){
  if (step == 5){
    if (mouseClick == 0) {
      ...
      s1.content = "Click on the screen to give some help";
      s1.location.x = 10;
      s1.location.y = 430;
      s1.display();
  ...
  if (step == 6){
    if(ball2.r > 15){
      ...
      ball2.display();
        ...
        s3.content = "And now you give power to the red ball.";
        s3.location.x = 10;
        s3.location.y = 430;
        s3.display();
        
        s4.content = "It is growing and sucking all the energy";
        s4.location.x = 10;
        s4.location.y = 450;
        s4.display();
        
        s5.content = "from the purple one!";
        s5.location.x = 10;
        s5.location.y = 470;
        s5.display();
...
void step7(){
  if (step == 7){
    if(time < stepTime + 6){
      ...
      s1.content = "Now the situation is changed.";
      s1.location.x = 10;
      s1.location.y = 430;
      s1.display();
      
        s2.content = "The red ball has its revenge!";
        s2.location.x = 10;
        s2.location.y = 470;
        s2.fontSize = 25;
        s2.display();
...
void step9(){
  if (step == 9){
    if(time < stepTime + 2){
      ...
      s1.content = "You just sentenced the red ball";
      s1.location.x = 10;
      s1.location.y = 430;
      s1.display();

      s2.content = "to bully forever.";
      s2.location.x = 10;
      s2.location.y = 470;
      s2.display();
